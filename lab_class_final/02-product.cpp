...
Use a parameterized constructor to initialize these attributes.
Implement a method called apply_discount() that reduces the price by a given percentage.
Call the function using an object pointer. */
